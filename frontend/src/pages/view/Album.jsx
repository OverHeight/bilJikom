...
<div className='Album'>
  ...
  <section id="Projects"
    class="w-fit mx-auto grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 justify-items-center justify-center gap-y-20 gap-x-14 mt-10 mb-5">
        ...
        <div className="card w-96 image-full duration-500 hover:scale-105">
            <figure><img src={Ghibli} alt="" /></figure>
    ...
    <div class="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
        <a href="#">
            <img src={Mononoke} class="h-80 rounded-t-xl" />
        </a>
    </div>
    ...
    <div class="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
        <a href="#">
            ...
            <div class="px-4 py-3 w-72">
                <span class="text-gray-400 mr-3 uppercase text-xs">user</span>
                <p class="text-lg font-bold text-black truncate block capitalize">Caption</p>
